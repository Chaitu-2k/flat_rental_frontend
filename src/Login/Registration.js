    ...
    <div>
       ...
       <form action="action_page.php" onSubmit={handleSubmit(onSubmit)}>
        <div className="container">
          ...
          <input type="text" placeholder="Enter username"  id="user" {...register("username",{required:"user name is required"})}/>
         ...
         />
          ...
          {errors.upassword && ( <small className="text-danger">{errors.upassword.message}</small>)}
          <hr />
